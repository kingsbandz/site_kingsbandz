...
* [Novel one-shot inner bounds for unassisted fully quantum channels via rate splitting](https://arxiv.org/abs/2102.01766){:target="_blank"}
  * with  Aditya Nema and [Pranab Sen](https://scholar.google.com/citations?user=Ka5re30AAAAJ&hl=en){:target="_blank"}
  * In Proceedings of [ISIT 2021](https://2021.ieee-isit.org/){:target="_blank"}
...
* [Improved Bounds for Perfect Sampling of k-Colorings in Graphs](https://dl.acm.org/doi/10.1145/3357713.3384244){:target="_blank"}
  ...
  * Recipient of the Danny Lewin Best Student Paper Award
  * Invited to to the Special Issue of the SIAM Journal of Computing (Currently under revision).
* [A novel approach for signal decomposition along a wide class of orthogonal polynomial bases](https://onlinelibrary.wiley.com/doi/full/10.1002/cmm4.1105){:target="_blank"}
  * with [Pradip Sircar](https://iitk.ac.in/new/pradip-sircar){:target="_blank"}
